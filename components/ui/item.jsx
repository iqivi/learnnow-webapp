	...
	"group/item flex items-center border border-transparent text-sm transition-colors [a]:hover:bg-accent/50 [a]:transition-colors duration-100 flex-wrap outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px]",
	{
		variants: {
			variant: {
				...
				outline: "border-border rounded-r-lg",
				outline_pill: "border-border rounded-r-lg bg-gray-200",
				muted: "bg-muted/50",
			},
			size: {
				default: "p-4 gap-4 ",
	...
	"flex shrink-0 items-center justify-center gap-2 group-has-[[data-slot=item-description]]/item:self-start [&_svg]:pointer-events-none group-has-[[data-slot=item-description]]/item:translate-y-0.5",
	{
		variants: {
			variant: {
				...
				image_md:
					"size-40 rounded-l-lg overflow-hidden [&_img]:size-full [&_img]:object-cover mb-6",
				image_bg:
					"size-80 rounded-l-lg overflow-hidden [&_img]:size-full [&_img]:object-cover",
			},
		},
		defaultVariants: {
			variant: "default",
